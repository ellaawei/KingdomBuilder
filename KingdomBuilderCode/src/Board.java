...
public class Board {
	...
	public Board() throws IOException {
		...
		board1 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board1.png")), "One.txt");
		board2 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board2.png")), "Two.txt");
		board3 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board3.png")), "Three.txt");
		board4 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board4.png")), "Four.txt");
		board5 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board5.png")), "Five.txt");
		board6 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board6.png")), "Six.txt");
		board7 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board7.png")), "Seven.txt");
		board8 = new SubBoard(ImageIO.read(this.getClass().getResource("/Image/Board8.png")), "Eight.txt");
		boards.add(board1);
		boards.add(board2);
		boards.add(board3);
		boards.add(board4);
		...
		for (int row = 0; row < 10; row++)
		{
			...
			{
				Hexadjacent[row][col].color = input.nextLine();
			}
		}
